...
**webhooks** | [**list[IoK8sApiAdmissionregistrationV1MutatingWebhook]**](IoK8sApiAdmissionregistrationV1MutatingWebhook.md) | Webhooks is a list of webhooks and the affected resources and operations. | [optional] 
