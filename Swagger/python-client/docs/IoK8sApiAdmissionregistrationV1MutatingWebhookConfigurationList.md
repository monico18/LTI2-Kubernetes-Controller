...
**items** | [**list[IoK8sApiAdmissionregistrationV1MutatingWebhookConfiguration]**](IoK8sApiAdmissionregistrationV1MutatingWebhookConfiguration.md) | List of MutatingWebhookConfiguration. | 
