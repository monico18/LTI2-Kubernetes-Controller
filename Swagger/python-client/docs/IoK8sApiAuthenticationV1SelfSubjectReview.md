...
**status** | [**IoK8sApiAuthenticationV1SelfSubjectReviewStatus**](IoK8sApiAuthenticationV1SelfSubjectReviewStatus.md) | Status is filled in by the server with the user attributes. | [optional] 
