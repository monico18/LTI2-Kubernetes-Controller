...
**items** | [**list[IoK8sApiAutoscalingV1HorizontalPodAutoscaler]**](IoK8sApiAutoscalingV1HorizontalPodAutoscaler.md) | items is the list of horizontal pod autoscaler objects. | 
