...
**items** | [**list[IoK8sApiCoreV1LimitRange]**](IoK8sApiCoreV1LimitRange.md) | Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/ | 
