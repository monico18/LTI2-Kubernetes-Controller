...
**items** | [**list[IoK8sApiCoreV1PersistentVolume]**](IoK8sApiCoreV1PersistentVolume.md) | items is a list of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes | 
