...
**items** | [**list[IoK8sApiCoreV1Pod]**](IoK8sApiCoreV1Pod.md) | List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md | 
