...
**items** | [**list[IoK8sApiCoreV1ServiceAccount]**](IoK8sApiCoreV1ServiceAccount.md) | List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ | 
