...
**conditions** | [**IoK8sApiDiscoveryV1EndpointConditions**](IoK8sApiDiscoveryV1EndpointConditions.md) | conditions contains information about the current status of the endpoint. | [optional] 
...
**hints** | [**IoK8sApiDiscoveryV1EndpointHints**](IoK8sApiDiscoveryV1EndpointHints.md) | hints contains information associated with how an endpoint should be consumed. | [optional] 
...
**target_ref** | [**IoK8sApiCoreV1ObjectReference**](IoK8sApiCoreV1ObjectReference.md) | targetRef is a reference to a Kubernetes object that represents this endpoint. | [optional] 
