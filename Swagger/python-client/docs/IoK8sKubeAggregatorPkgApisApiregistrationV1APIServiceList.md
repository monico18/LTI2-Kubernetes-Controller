...
**items** | [**list[IoK8sKubeAggregatorPkgApisApiregistrationV1APIService]**](IoK8sKubeAggregatorPkgApisApiregistrationV1APIService.md) | Items is the list of APIService | 
