...
class IoK8sApiBatchV1JobSpec(object):
    ...
    def backoff_limit_per_index(self):
        """Gets the backoff_limit_per_index of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        ...
        :return: The backoff_limit_per_index of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def backoff_limit_per_index(self, backoff_limit_per_index):
        """Sets the backoff_limit_per_index of this IoK8sApiBatchV1JobSpec.

        Specifies the limit for the number of retries within an index before marking this index as failed. When enabled the number of failures per index is kept in the pod's batch.kubernetes.io/job-index-failure-count annotation. It can only be set when Job's completionMode=Indexed, and the Pod's restart policy is Never. The field is immutable. This field is beta-level. It can be used when the `JobBackoffLimitPerIndex` feature gate is enabled (enabled by default).  # noqa: E501

        :param backoff_limit_per_index: The backoff_limit_per_index of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :type: int
        """
    ...
    def completion_mode(self, completion_mode):
        """Sets the completion_mode of this IoK8sApiBatchV1JobSpec.

        completionMode specifies how Pod completions are tracked. It can be `NonIndexed` (default) or `Indexed`.  `NonIndexed` means that the Job is considered complete when there have been .spec.completions successfully completed Pods. Each Pod completion is homologous to each other.  `Indexed` means that the Pods of a Job get an associated completion index from 0 to (.spec.completions - 1), available in the annotation batch.kubernetes.io/job-completion-index. The Job is considered complete when there is one successfully completed Pod for each index. When value is `Indexed`, .spec.completions must be specified and `.spec.parallelism` must be less than or equal to 10^5. In addition, The Pod name takes the form `$(job-name)-$(index)-$(random-string)`, the Pod hostname takes the form `$(job-name)-$(index)`.  More completion modes can be added in the future. If the Job controller observes a mode that it doesn't recognize, which is possible during upgrades due to version skew, the controller skips updates for the Job.  Possible enum values:  - `\"Indexed\"` is a Job completion mode. In this mode, the Pods of a Job get an associated completion index from 0 to (.spec.completions - 1). The Job is considered complete when a Pod completes for each completion index.  - `\"NonIndexed\"` is a Job completion mode. In this mode, the Job is considered complete when there have been .spec.completions successfully completed Pods. Pod completions are homologous to each other.  # noqa: E501

        :param completion_mode: The completion_mode of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :type: str
        """
        allowed_values = ["Indexed", "NonIndexed"]  # noqa: E501
        if (self._configuration.client_side_validation and
                completion_mode not in allowed_values):
            raise ValueError(
                "Invalid value for `completion_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(completion_mode, allowed_values)
            )
    ...
    def max_failed_indexes(self):
        """Gets the max_failed_indexes of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        ...
        :return: The max_failed_indexes of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def max_failed_indexes(self, max_failed_indexes):
        """Sets the max_failed_indexes of this IoK8sApiBatchV1JobSpec.

        Specifies the maximal number of failed indexes before marking the Job as failed, when backoffLimitPerIndex is set. Once the number of failed indexes exceeds this number the entire Job is marked as Failed and its execution is terminated. When left as null the job continues execution of all of its indexes and is marked with the `Complete` Job condition. It can only be specified when backoffLimitPerIndex is set. It can be null or up to completions. It is required and must be less than or equal to 10^4 when is completions greater than 10^5. This field is beta-level. It can be used when the `JobBackoffLimitPerIndex` feature gate is enabled (enabled by default).  # noqa: E501

        :param max_failed_indexes: The max_failed_indexes of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :type: int
        """
    ...
    def pod_failure_policy(self):
        """Gets the pod_failure_policy of this IoK8sApiBatchV1JobSpec.  # noqa: E501

        Specifies the policy of handling failed pods. In particular, it allows to specify the set of actions and conditions which need to be satisfied to take the associated action. If empty, the default behaviour applies - the counter of failed pods, represented by the jobs's .status.failed field, is incremented and it is checked against the backoffLimit. This field cannot be used in combination with restartPolicy=OnFailure.  This field is beta-level. It can be used when the `JobPodFailurePolicy` feature gate is enabled (enabled by default).  # noqa: E501

        :return: The pod_failure_policy of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :rtype: IoK8sApiBatchV1PodFailurePolicy
        """
        return self._pod_failure_policy

    @pod_failure_policy.setter
    def pod_failure_policy(self, pod_failure_policy):
        """Sets the pod_failure_policy of this IoK8sApiBatchV1JobSpec.

        Specifies the policy of handling failed pods. In particular, it allows to specify the set of actions and conditions which need to be satisfied to take the associated action. If empty, the default behaviour applies - the counter of failed pods, represented by the jobs's .status.failed field, is incremented and it is checked against the backoffLimit. This field cannot be used in combination with restartPolicy=OnFailure.  This field is beta-level. It can be used when the `JobPodFailurePolicy` feature gate is enabled (enabled by default).  # noqa: E501

        :param pod_failure_policy: The pod_failure_policy of this IoK8sApiBatchV1JobSpec.  # noqa: E501
    ...
    def pod_replacement_policy(self, pod_replacement_policy):
        """Sets the pod_replacement_policy of this IoK8sApiBatchV1JobSpec.

        podReplacementPolicy specifies when to create replacement Pods. Possible values are: - TerminatingOrFailed means that we recreate pods   when they are terminating (has a metadata.deletionTimestamp) or failed. - Failed means to wait until a previously created Pod is fully terminated (has phase   Failed or Succeeded) before creating a replacement Pod.  When using podFailurePolicy, Failed is the the only allowed value. TerminatingOrFailed and Failed are allowed values when podFailurePolicy is not in use. This is an beta field. To use this, enable the JobPodReplacementPolicy feature toggle. This is on by default.  Possible enum values:  - `\"Failed\"` means to wait until a previously created Pod is fully terminated (has phase Failed or Succeeded) before creating a replacement Pod.  - `\"TerminatingOrFailed\"` means that we recreate pods when they are terminating (has a metadata.deletionTimestamp) or failed.  # noqa: E501

        :param pod_replacement_policy: The pod_replacement_policy of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :type: str
        """
        allowed_values = ["Failed", "TerminatingOrFailed"]  # noqa: E501
        if (self._configuration.client_side_validation and
                pod_replacement_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `pod_replacement_policy` ({0}), must be one of {1}"  # noqa: E501
                .format(pod_replacement_policy, allowed_values)
            )
    ...
    @property
    def suspend(self):
        """Gets the suspend of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        ...
        :return: The suspend of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def suspend(self, suspend):
        """Sets the suspend of this IoK8sApiBatchV1JobSpec.

        suspend specifies whether the Job controller should create Pods or not. If a Job is created with suspend set to true, no Pods are created by the Job controller. If a Job is suspended after creation (i.e. the flag goes from false to true), the Job controller will delete all active Pods associated with this Job. Users must design their workload to gracefully handle this. Suspending a Job will reset the StartTime field of the Job, effectively resetting the ActiveDeadlineSeconds timer too. Defaults to false.  # noqa: E501

        :param suspend: The suspend of this IoK8sApiBatchV1JobSpec.  # noqa: E501
        :type: bool
        """
    ...
    def template(self):
        ...
        Describes the pod that will be created when executing a job. The only allowed template.spec.restartPolicy values are \"Never\" or \"OnFailure\". More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/  # noqa: E501
