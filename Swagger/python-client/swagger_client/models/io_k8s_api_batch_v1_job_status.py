...
class IoK8sApiBatchV1JobStatus(object):
    ...
    def __init__(self, active=None, completed_indexes=None, completion_time=None, conditions=None, failed=None, failed_indexes=None, ready=None, start_time=None, succeeded=None, terminating=None, uncounted_terminated_pods=None, _configuration=None):  # noqa: E501
    ...
    def completed_indexes(self):
        """Gets the completed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        ...
        :return: The completed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def completed_indexes(self, completed_indexes):
        """Sets the completed_indexes of this IoK8sApiBatchV1JobStatus.

        completedIndexes holds the completed indexes when .spec.completionMode = \"Indexed\" in a text format. The indexes are represented as decimal integers separated by commas. The numbers are listed in increasing order. Three or more consecutive numbers are compressed and represented by the first and last element of the series, separated by a hyphen. For example, if the completed indexes are 1, 3, 4, 5 and 7, they are represented as \"1,3-5,7\".  # noqa: E501

        :param completed_indexes: The completed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :type: str
        """
    ...
    def failed_indexes(self):
        """Gets the failed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        ...
        :return: The failed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def failed_indexes(self, failed_indexes):
        """Sets the failed_indexes of this IoK8sApiBatchV1JobStatus.

        FailedIndexes holds the failed indexes when backoffLimitPerIndex=true. The indexes are represented in the text format analogous as for the `completedIndexes` field, ie. they are kept as decimal integers separated by commas. The numbers are listed in increasing order. Three or more consecutive numbers are compressed and represented by the first and last element of the series, separated by a hyphen. For example, if the failed indexes are 1, 3, 4, 5 and 7, they are represented as \"1,3-5,7\". This field is beta-level. It can be used when the `JobBackoffLimitPerIndex` feature gate is enabled (enabled by default).  # noqa: E501

        :param failed_indexes: The failed_indexes of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ready(self):
        """Gets the ready of this IoK8sApiBatchV1JobStatus.  # noqa: E501

        The number of pods which have a Ready condition.  # noqa: E501

        :return: The ready of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :rtype: int
        """
        return self._ready
    ...
    def ready(self, ready):
        """Sets the ready of this IoK8sApiBatchV1JobStatus.

        The number of pods which have a Ready condition.  # noqa: E501

        :param ready: The ready of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :type: int
        """
    ...
    def terminating(self):
        """Gets the terminating of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        ...
        :return: The terminating of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def terminating(self, terminating):
        """Sets the terminating of this IoK8sApiBatchV1JobStatus.

        The number of pods which are terminating (in phase Pending or Running and have a deletionTimestamp).  This field is beta-level. The job controller populates the field when the feature gate JobPodReplacementPolicy is enabled (enabled by default).  # noqa: E501

        :param terminating: The terminating of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :type: int
        """
    ...
    def uncounted_terminated_pods(self):
        """Gets the uncounted_terminated_pods of this IoK8sApiBatchV1JobStatus.  # noqa: E501

        uncountedTerminatedPods holds the UIDs of Pods that have terminated but the job controller hasn't yet accounted for in the status counters.  The job controller creates pods with a finalizer. When a pod terminates (succeeded or failed), the controller does three steps to account for it in the job status:  1. Add the pod UID to the arrays in this field. 2. Remove the pod finalizer. 3. Remove the pod UID from the arrays while increasing the corresponding     counter.  Old jobs might not be tracked using this field, in which case the field remains null.  # noqa: E501

        :return: The uncounted_terminated_pods of this IoK8sApiBatchV1JobStatus.  # noqa: E501
        :rtype: IoK8sApiBatchV1UncountedTerminatedPods
        """
    ...
    def uncounted_terminated_pods(self, uncounted_terminated_pods):
        """Sets the uncounted_terminated_pods of this IoK8sApiBatchV1JobStatus.

        uncountedTerminatedPods holds the UIDs of Pods that have terminated but the job controller hasn't yet accounted for in the status counters.  The job controller creates pods with a finalizer. When a pod terminates (succeeded or failed), the controller does three steps to account for it in the job status:  1. Add the pod UID to the arrays in this field. 2. Remove the pod finalizer. 3. Remove the pod UID from the arrays while increasing the corresponding     counter.  Old jobs might not be tracked using this field, in which case the field remains null.  # noqa: E501

        :param uncounted_terminated_pods: The uncounted_terminated_pods of this IoK8sApiBatchV1JobStatus.  # noqa: E501
