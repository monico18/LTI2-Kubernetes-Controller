...
class IoK8sApiBatchV1PodFailurePolicyRule(object):
    ...
    def __init__(self, action=None, on_exit_codes=None, on_pod_conditions=None, _configuration=None):  # noqa: E501
        """IoK8sApiBatchV1PodFailurePolicyRule - a model defined in Swagger"""  # noqa: E501
    ...
    def action(self, action):
        """Sets the action of this IoK8sApiBatchV1PodFailurePolicyRule.

        Specifies the action taken on a pod failure when the requirements are satisfied. Possible values are:  - FailJob: indicates that the pod's job is marked as Failed and all   running pods are terminated. - FailIndex: indicates that the pod's index is marked as Failed and will   not be restarted.   This value is beta-level. It can be used when the   `JobBackoffLimitPerIndex` feature gate is enabled (enabled by default). - Ignore: indicates that the counter towards the .backoffLimit is not   incremented and a replacement pod is created. - Count: indicates that the pod is handled in the default way - the   counter towards the .backoffLimit is incremented. Additional values are considered to be added in the future. Clients should react to an unknown action by skipping the rule.  Possible enum values:  - `\"Count\"` This is an action which might be taken on a pod failure - the pod failure is handled in the default way - the counter towards .backoffLimit, represented by the job's .status.failed field, is incremented.  - `\"FailIndex\"` This is an action which might be taken on a pod failure - mark the Job's index as failed to avoid restarts within this index. This action can only be used when backoffLimitPerIndex is set. This value is beta-level.  - `\"FailJob\"` This is an action which might be taken on a pod failure - mark the pod's job as Failed and terminate all running pods.  - `\"Ignore\"` This is an action which might be taken on a pod failure - the counter towards .backoffLimit, represented by the job's .status.failed field, is not incremented and a replacement pod is created.  # noqa: E501

        :param action: The action of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and action is None:
            raise ValueError("Invalid value for `action`, must not be `None`")  # noqa: E501
        allowed_values = ["Count", "FailIndex", "FailJob", "Ignore"]  # noqa: E501
    ...
    def on_exit_codes(self):
        """Gets the on_exit_codes of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501

        Represents the requirement on the container exit codes.  # noqa: E501

        :return: The on_exit_codes of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
        :rtype: IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirement
        """
        return self._on_exit_codes

    @on_exit_codes.setter
    def on_exit_codes(self, on_exit_codes):
        """Sets the on_exit_codes of this IoK8sApiBatchV1PodFailurePolicyRule.

        Represents the requirement on the container exit codes.  # noqa: E501

        :param on_exit_codes: The on_exit_codes of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
    ...
    def on_pod_conditions(self):
        """Gets the on_pod_conditions of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
        ...
        :return: The on_pod_conditions of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
        :rtype: list[IoK8sApiBatchV1PodFailurePolicyOnPodConditionsPattern]
        """
        return self._on_pod_conditions

    @on_pod_conditions.setter
    def on_pod_conditions(self, on_pod_conditions):
        """Sets the on_pod_conditions of this IoK8sApiBatchV1PodFailurePolicyRule.

        Represents the requirement on the pod conditions. The requirement is represented as a list of pod condition patterns. The requirement is satisfied if at least one pattern matches an actual pod condition. At most 20 elements are allowed.  # noqa: E501

        :param on_pod_conditions: The on_pod_conditions of this IoK8sApiBatchV1PodFailurePolicyRule.  # noqa: E501
        :type: list[IoK8sApiBatchV1PodFailurePolicyOnPodConditionsPattern]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiBatchV1PodFailurePolicyRule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiBatchV1PodFailurePolicyRule):
            return False
