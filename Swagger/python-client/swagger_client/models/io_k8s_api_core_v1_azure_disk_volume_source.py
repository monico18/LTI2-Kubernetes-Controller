...
class IoK8sApiCoreV1AzureDiskVolumeSource(object):
    ...
    def caching_mode(self):
        ...
        cachingMode is the Host Caching mode: None, Read Only, Read Write.  Possible enum values:  - `\"None\"`  - `\"ReadOnly\"`  - `\"ReadWrite\"`  # noqa: E501
    ...
    def caching_mode(self, caching_mode):
        ...
        if (self._configuration.client_side_validation and
                caching_mode not in allowed_values):
            raise ValueError(
                "Invalid value for `caching_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(caching_mode, allowed_values)
            )
    ...
    def kind(self):
        ...
        kind expected values are Shared: multiple blob disks per storage account  Dedicated: single blob disk per storage account  Managed: azure managed data disk (only in managed availability set). defaults to shared  Possible enum values:  - `\"Dedicated\"`  - `\"Managed\"`  - `\"Shared\"`  # noqa: E501
    ...
    def kind(self, kind):
        ...
        :type: str
        """
        allowed_values = ["Dedicated", "Managed", "Shared"]  # noqa: E501
        if (self._configuration.client_side_validation and
