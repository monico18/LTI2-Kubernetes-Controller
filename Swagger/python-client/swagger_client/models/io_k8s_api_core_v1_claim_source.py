...
class IoK8sApiCoreV1ClaimSource(object):
    ...
    def __init__(self, resource_claim_name=None, resource_claim_template_name=None, _configuration=None):  # noqa: E501
        """IoK8sApiCoreV1ClaimSource - a model defined in Swagger"""  # noqa: E501
    ...
    def resource_claim_name(self):
        """Gets the resource_claim_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501

        ResourceClaimName is the name of a ResourceClaim object in the same namespace as this pod.  # noqa: E501

        :return: The resource_claim_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_claim_name(self, resource_claim_name):
        """Sets the resource_claim_name of this IoK8sApiCoreV1ClaimSource.

        ResourceClaimName is the name of a ResourceClaim object in the same namespace as this pod.  # noqa: E501

        :param resource_claim_name: The resource_claim_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501
        :type: str
        """
    ...
    def resource_claim_template_name(self):
        """Gets the resource_claim_template_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501
        ...
        :return: The resource_claim_template_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_claim_template_name(self, resource_claim_template_name):
        """Sets the resource_claim_template_name of this IoK8sApiCoreV1ClaimSource.

        ResourceClaimTemplateName is the name of a ResourceClaimTemplate object in the same namespace as this pod.  The template will be used to create a new ResourceClaim, which will be bound to this pod. When this pod is deleted, the ResourceClaim will also be deleted. The pod name and resource name, along with a generated component, will be used to form a unique name for the ResourceClaim, which will be recorded in pod.status.resourceClaimStatuses.  This field is immutable and no changes will be made to the corresponding ResourceClaim by the control plane after creating the ResourceClaim.  # noqa: E501

        :param resource_claim_template_name: The resource_claim_template_name of this IoK8sApiCoreV1ClaimSource.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1ClaimSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiCoreV1ClaimSource):
            return False
