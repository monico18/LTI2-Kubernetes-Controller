...
class IoK8sApiCoreV1ConfigMapNodeConfigSource(object):
    ...
    def __init__(self, kubelet_config_key=None, name=None, namespace=None, resource_version=None, uid=None, _configuration=None):  # noqa: E501
    ...
    def kubelet_config_key(self, kubelet_config_key):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and kubelet_config_key is None:
