...
class IoK8sApiCoreV1NodeStatus(object):
    ...
    def __init__(self, addresses=None, allocatable=None, capacity=None, conditions=None, config=None, daemon_endpoints=None, images=None, node_info=None, phase=None, volumes_attached=None, volumes_in_use=None, _configuration=None):  # noqa: E501
