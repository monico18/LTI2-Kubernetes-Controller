...
class IoK8sApiCoreV1PersistentVolumeSpec(object):
    ...
    def persistent_volume_reclaim_policy(self, persistent_volume_reclaim_policy):
        ...
        if (self._configuration.client_side_validation and
                persistent_volume_reclaim_policy not in allowed_values):
            raise ValueError(
    ...
    def volume_attributes_class_name(self):
        """Gets the volume_attributes_class_name of this IoK8sApiCoreV1PersistentVolumeSpec.  # noqa: E501
        ...
        :return: The volume_attributes_class_name of this IoK8sApiCoreV1PersistentVolumeSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def volume_attributes_class_name(self, volume_attributes_class_name):
        """Sets the volume_attributes_class_name of this IoK8sApiCoreV1PersistentVolumeSpec.

        Name of VolumeAttributesClass to which this persistent volume belongs. Empty value is not allowed. When this field is not set, it indicates that this volume does not belong to any VolumeAttributesClass. This field is mutable and can be changed by the CSI driver after a volume has been updated successfully to a new class. For an unbound PersistentVolume, the volumeAttributesClassName will be matched with unbound PersistentVolumeClaims during the binding process. This is an alpha field and requires enabling VolumeAttributesClass feature.  # noqa: E501

        :param volume_attributes_class_name: The volume_attributes_class_name of this IoK8sApiCoreV1PersistentVolumeSpec.  # noqa: E501
        :type: str
        """
