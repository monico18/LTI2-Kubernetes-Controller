...
class IoK8sApiCoreV1PodSecurityContext(object):
    ...
    def fs_group_change_policy(self, fs_group_change_policy):
        ...
        :type: str
        """
        allowed_values = ["Always", "OnRootMismatch"]  # noqa: E501
        if (self._configuration.client_side_validation and
                fs_group_change_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `fs_group_change_policy` ({0}), must be one of {1}"  # noqa: E501
                .format(fs_group_change_policy, allowed_values)
            )
