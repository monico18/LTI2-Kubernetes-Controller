...
class IoK8sApiCoreV1PodSpec(object):
    ...
    swagger_types = {
        ...
        'resource_claims': 'list[IoK8sApiCoreV1PodResourceClaim]',
        'restart_policy': 'str',
        'runtime_class_name': 'str',
        'scheduler_name': 'str',
        'scheduling_gates': 'list[IoK8sApiCoreV1PodSchedulingGate]',
    ...
    def ephemeral_containers(self):
        """Gets the ephemeral_containers of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The ephemeral_containers of this IoK8sApiCoreV1PodSpec.  # noqa: E501
    ...
    def ephemeral_containers(self, ephemeral_containers):
        ...
        :type: list[IoK8sApiCoreV1EphemeralContainer]
        """
    ...
    @property
    def host_users(self):
        """Gets the host_users of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The host_users of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def host_users(self, host_users):
        """Sets the host_users of this IoK8sApiCoreV1PodSpec.

        Use the host's user namespace. Optional: Default to true. If set to true or not present, the pod will be run in the host user namespace, useful for when the pod needs a feature only available to the host user namespace, such as loading a kernel module with CAP_SYS_MODULE. When set to false, a new userns is created for the pod. Setting false is useful for mitigating container breakout vulnerabilities even allowing users to run their containers as root without actually having root privileges on the host. This field is alpha-level and is only honored by servers that enable the UserNamespacesSupport feature.  # noqa: E501

        :param host_users: The host_users of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def overhead(self):
        """Gets the overhead of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The overhead of this IoK8sApiCoreV1PodSpec.  # noqa: E501
    ...
    def preemption_policy(self):
        """Gets the preemption_policy of this IoK8sApiCoreV1PodSpec.  # noqa: E501

        PreemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset.  Possible enum values:  - `\"Never\"` means that pod never preempts other pods with lower priority.  - `\"PreemptLowerPriority\"` means that pod can preempt other pods with lower priority.  # noqa: E501

        :return: The preemption_policy of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def preemption_policy(self, preemption_policy):
        ...
        :type: str
        """
        allowed_values = ["Never", "PreemptLowerPriority"]  # noqa: E501
        if (self._configuration.client_side_validation and
                preemption_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `preemption_policy` ({0}), must be one of {1}"  # noqa: E501
                .format(preemption_policy, allowed_values)
            )
    ...
    def resource_claims(self):
        """Gets the resource_claims of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The resource_claims of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :rtype: list[IoK8sApiCoreV1PodResourceClaim]
        """
        return self._resource_claims

    @resource_claims.setter
    def resource_claims(self, resource_claims):
        """Sets the resource_claims of this IoK8sApiCoreV1PodSpec.

        ResourceClaims defines which ResourceClaims must be allocated and reserved before the Pod is allowed to start. The resources will be made available to those containers which consume them by name.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable.  # noqa: E501

        :param resource_claims: The resource_claims of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :type: list[IoK8sApiCoreV1PodResourceClaim]
        """
    ...
    def restart_policy(self):
        ...
        Restart policy for all containers within the pod. One of Always, OnFailure, Never. In some contexts, only a subset of those values may be permitted. Default to Always. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#restart-policy  Possible enum values:  - `\"Always\"`  - `\"Never\"`  - `\"OnFailure\"`  # noqa: E501
    ...
    def restart_policy(self, restart_policy):
        ...
        if (self._configuration.client_side_validation and
                restart_policy not in allowed_values):
            raise ValueError(
    ...
    def scheduling_gates(self):
        """Gets the scheduling_gates of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The scheduling_gates of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :rtype: list[IoK8sApiCoreV1PodSchedulingGate]
        """
        return self._scheduling_gates

    @scheduling_gates.setter
    def scheduling_gates(self, scheduling_gates):
        """Sets the scheduling_gates of this IoK8sApiCoreV1PodSpec.

        SchedulingGates is an opaque list of values that if specified will block scheduling the pod. If schedulingGates is not empty, the pod will stay in the SchedulingGated state and the scheduler will not attempt to schedule the pod.  SchedulingGates can only be set at pod creation time, and be removed only afterwards.  This is a beta feature enabled by the PodSchedulingReadiness feature gate.  # noqa: E501

        :param scheduling_gates: The scheduling_gates of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :type: list[IoK8sApiCoreV1PodSchedulingGate]
        """
    ...
    def set_hostname_as_fqdn(self):
        """Gets the set_hostname_as_fqdn of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The set_hostname_as_fqdn of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def set_hostname_as_fqdn(self, set_hostname_as_fqdn):
        """Sets the set_hostname_as_fqdn of this IoK8sApiCoreV1PodSpec.

        If true the pod's hostname will be configured as the pod's FQDN, rather than the leaf name (the default). In Linux containers, this means setting the FQDN in the hostname field of the kernel (the nodename field of struct utsname). In Windows containers, this means setting the registry value of hostname for the registry key HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters to FQDN. If a pod does not have FQDN, this has no effect. Default to false.  # noqa: E501

        :param set_hostname_as_fqdn: The set_hostname_as_fqdn of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        :type: bool
        """
    ...
    def topology_spread_constraints(self):
        """Gets the topology_spread_constraints of this IoK8sApiCoreV1PodSpec.  # noqa: E501
        ...
        :return: The topology_spread_constraints of this IoK8sApiCoreV1PodSpec.  # noqa: E501
