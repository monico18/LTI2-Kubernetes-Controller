...
class IoK8sApiCoreV1ReplicationControllerStatus(object):
    ...
    def __init__(self, available_replicas=None, conditions=None, fully_labeled_replicas=None, observed_generation=None, ready_replicas=None, replicas=None, _configuration=None):  # noqa: E501
