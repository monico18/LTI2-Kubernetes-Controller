...
class IoK8sApiCoreV1Secret(object):
    ...
    def __init__(self, api_version=None, data=None, immutable=None, kind=None, metadata=None, string_data=None, type=None, _configuration=None):  # noqa: E501
    ...
    @property
    def immutable(self):
        """Gets the immutable of this IoK8sApiCoreV1Secret.  # noqa: E501
        ...
        :return: The immutable of this IoK8sApiCoreV1Secret.  # noqa: E501
        :rtype: bool
        """
    ...
    def immutable(self, immutable):
        """Sets the immutable of this IoK8sApiCoreV1Secret.

        Immutable, if set to true, ensures that data stored in the Secret cannot be updated (only object metadata can be modified). If not set to true, the field can be modified at any time. Defaulted to nil.  # noqa: E501

        :param immutable: The immutable of this IoK8sApiCoreV1Secret.  # noqa: E501
        :type: bool
        """
