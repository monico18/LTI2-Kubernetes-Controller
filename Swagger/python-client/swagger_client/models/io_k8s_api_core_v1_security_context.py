...
class IoK8sApiCoreV1SecurityContext(object):
    ...
    def proc_mount(self, proc_mount):
        ...
        :type: str
        """
        allowed_values = ["Default", "Unmasked"]  # noqa: E501
        if (self._configuration.client_side_validation and
                proc_mount not in allowed_values):
            raise ValueError(
                "Invalid value for `proc_mount` ({0}), must be one of {1}"  # noqa: E501
                .format(proc_mount, allowed_values)
            )
