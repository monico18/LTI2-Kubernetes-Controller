...
class IoK8sApiCoreV1ServiceSpec(object):
    ...
    def allocate_load_balancer_node_ports(self):
        """Gets the allocate_load_balancer_node_ports of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        ...
        :return: The allocate_load_balancer_node_ports of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def allocate_load_balancer_node_ports(self, allocate_load_balancer_node_ports):
        """Sets the allocate_load_balancer_node_ports of this IoK8sApiCoreV1ServiceSpec.

        allocateLoadBalancerNodePorts defines if NodePorts will be automatically allocated for services with type LoadBalancer.  Default is \"true\". It may be set to \"false\" if the cluster load-balancer does not rely on NodePorts.  If the caller requests specific NodePorts (by specifying a value), those requests will be respected, regardless of this field. This field may only be set for services with type LoadBalancer and will be cleared if the type is changed to any other type.  # noqa: E501

        :param allocate_load_balancer_node_ports: The allocate_load_balancer_node_ports of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: bool
        """
    ...
    def cluster_ips(self):
        """Gets the cluster_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        ...
        :return: The cluster_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def cluster_ips(self, cluster_ips):
        """Sets the cluster_ips of this IoK8sApiCoreV1ServiceSpec.

        ClusterIPs is a list of IP addresses assigned to this service, and are usually assigned randomly.  If an address is specified manually, is in-range (as per system configuration), and is not in use, it will be allocated to the service; otherwise creation of the service will fail. This field may not be changed through updates unless the type field is also being changed to ExternalName (which requires this field to be empty) or the type field is being changed from ExternalName (in which case this field may optionally be specified, as describe above).  Valid values are \"None\", empty string (\"\"), or a valid IP address.  Setting this to \"None\" makes a \"headless service\" (no virtual IP), which is useful when direct endpoint connections are preferred and proxying is not required.  Only applies to types ClusterIP, NodePort, and LoadBalancer. If this field is specified when creating a Service of type ExternalName, creation will fail. This field will be wiped when updating a Service to type ExternalName.  If this field is not specified, it will be initialized from the clusterIP field.  If this field is specified, clients must ensure that clusterIPs[0] and clusterIP have the same value.  This field may hold a maximum of two entries (dual-stack IPs, in either order). These IPs must correspond to the values of the ipFamilies field. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies  # noqa: E501

        :param cluster_ips: The cluster_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def external_ips(self):
        """Gets the external_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        ...
        :return: The external_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def external_ips(self, external_ips):
        """Sets the external_ips of this IoK8sApiCoreV1ServiceSpec.

        externalIPs is a list of IP addresses for which nodes in the cluster will also accept traffic for this service.  These IPs are not managed by Kubernetes.  The user is responsible for ensuring that traffic arrives at a node with this IP.  A common example is external load-balancers that are not part of the Kubernetes system.  # noqa: E501

        :param external_ips: The external_ips of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def external_traffic_policy(self, external_traffic_policy):
        ...
        :type: str
        """
        allowed_values = ["Cluster", "Cluster", "Local", "Local"]  # noqa: E501
    ...
    def internal_traffic_policy(self):
        """Gets the internal_traffic_policy of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501

        InternalTrafficPolicy describes how nodes distribute service traffic they receive on the ClusterIP. If set to \"Local\", the proxy will assume that pods only want to talk to endpoints of the service on the same node as the pod, dropping the traffic if there are no local endpoints. The default value, \"Cluster\", uses the standard behavior of routing to all endpoints evenly (possibly modified by topology and other features).  Possible enum values:  - `\"Cluster\"` routes traffic to all endpoints.  - `\"Local\"` routes traffic only to endpoints on the same node as the client pod (dropping the traffic if there are no local endpoints).  # noqa: E501

        :return: The internal_traffic_policy of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_traffic_policy(self, internal_traffic_policy):
        """Sets the internal_traffic_policy of this IoK8sApiCoreV1ServiceSpec.

        InternalTrafficPolicy describes how nodes distribute service traffic they receive on the ClusterIP. If set to \"Local\", the proxy will assume that pods only want to talk to endpoints of the service on the same node as the pod, dropping the traffic if there are no local endpoints. The default value, \"Cluster\", uses the standard behavior of routing to all endpoints evenly (possibly modified by topology and other features).  Possible enum values:  - `\"Cluster\"` routes traffic to all endpoints.  - `\"Local\"` routes traffic only to endpoints on the same node as the client pod (dropping the traffic if there are no local endpoints).  # noqa: E501

        :param internal_traffic_policy: The internal_traffic_policy of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: str
        """
        allowed_values = ["Cluster", "Local"]  # noqa: E501
        if (self._configuration.client_side_validation and
                internal_traffic_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `internal_traffic_policy` ({0}), must be one of {1}"  # noqa: E501
                .format(internal_traffic_policy, allowed_values)
            )
    ...
    def ip_families(self):
        """Gets the ip_families of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        ...
        :return: The ip_families of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def ip_families(self, ip_families):
        """Sets the ip_families of this IoK8sApiCoreV1ServiceSpec.

        IPFamilies is a list of IP families (e.g. IPv4, IPv6) assigned to this service. This field is usually assigned automatically based on cluster configuration and the ipFamilyPolicy field. If this field is specified manually, the requested family is available in the cluster, and ipFamilyPolicy allows it, it will be used; otherwise creation of the service will fail. This field is conditionally mutable: it allows for adding or removing a secondary IP family, but it does not allow changing the primary IP family of the Service. Valid values are \"IPv4\" and \"IPv6\".  This field only applies to Services of types ClusterIP, NodePort, and LoadBalancer, and does apply to \"headless\" services. This field will be wiped when updating a Service to type ExternalName.  This field may hold a maximum of two entries (dual-stack families, in either order).  These families must correspond to the values of the clusterIPs field, if specified. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field.  # noqa: E501

        :param ip_families: The ip_families of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def ip_family_policy(self, ip_family_policy):
        """Sets the ip_family_policy of this IoK8sApiCoreV1ServiceSpec.

        IPFamilyPolicy represents the dual-stack-ness requested or required by this Service. If there is no value provided, then this field will be set to SingleStack. Services can be \"SingleStack\" (a single IP family), \"PreferDualStack\" (two IP families on dual-stack configured clusters or a single IP family on single-stack clusters), or \"RequireDualStack\" (two IP families on dual-stack configured clusters, otherwise fail). The ipFamilies and clusterIPs fields depend on the value of this field. This field will be wiped when updating a service to type ExternalName.  Possible enum values:  - `\"PreferDualStack\"` indicates that this service prefers dual-stack when the cluster is configured for dual-stack. If the cluster is not configured for dual-stack the service will be assigned a single IPFamily. If the IPFamily is not set in service.spec.ipFamilies then the service will be assigned the default IPFamily configured on the cluster  - `\"RequireDualStack\"` indicates that this service requires dual-stack. Using IPFamilyPolicyRequireDualStack on a single stack cluster will result in validation errors. The IPFamilies (and their order) assigned to this service is based on service.spec.ipFamilies. If service.spec.ipFamilies was not provided then it will be assigned according to how they are configured on the cluster. If service.spec.ipFamilies has only one entry then the alternative IPFamily will be added by apiserver  - `\"SingleStack\"` indicates that this service is required to have a single IPFamily. The IPFamily assigned is based on the default IPFamily used by the cluster or as identified by service.spec.ipFamilies field  # noqa: E501

        :param ip_family_policy: The ip_family_policy of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: str
        """
        allowed_values = ["PreferDualStack", "RequireDualStack", "SingleStack"]  # noqa: E501
        if (self._configuration.client_side_validation and
                ip_family_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `ip_family_policy` ({0}), must be one of {1}"  # noqa: E501
                .format(ip_family_policy, allowed_values)
            )
    ...
    def load_balancer_class(self):
        """Gets the load_balancer_class of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        ...
        :return: The load_balancer_class of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def load_balancer_class(self, load_balancer_class):
        """Sets the load_balancer_class of this IoK8sApiCoreV1ServiceSpec.

        loadBalancerClass is the class of the load balancer implementation this Service belongs to. If specified, the value of this field must be a label-style identifier, with an optional prefix, e.g. \"internal-vip\" or \"example.com/internal-vip\". Unprefixed names are reserved for end-users. This field can only be set when the Service type is 'LoadBalancer'. If not set, the default load balancer implementation is used, today this is typically done through the cloud provider integration, but should apply for any default implementation. If set, it is assumed that a load balancer implementation is watching for Services with a matching class. Any default load balancer implementation (e.g. cloud providers) should ignore Services that set this field. This field can only be set when creating or updating a Service to type 'LoadBalancer'. Once set, it can not be changed. This field will be wiped when a service is updated to a non 'LoadBalancer' type.  # noqa: E501

        :param load_balancer_class: The load_balancer_class of this IoK8sApiCoreV1ServiceSpec.  # noqa: E501
        :type: str
        """
    ...
    def session_affinity(self, session_affinity):
        ...
        if (self._configuration.client_side_validation and
                session_affinity not in allowed_values):
            raise ValueError(
