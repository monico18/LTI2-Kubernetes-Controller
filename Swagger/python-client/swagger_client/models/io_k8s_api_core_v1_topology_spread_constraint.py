...
class IoK8sApiCoreV1TopologySpreadConstraint(object):
    ...
    def __init__(self, label_selector=None, match_label_keys=None, max_skew=None, min_domains=None, node_affinity_policy=None, node_taints_policy=None, topology_key=None, when_unsatisfiable=None, _configuration=None):  # noqa: E501
        """IoK8sApiCoreV1TopologySpreadConstraint - a model defined in Swagger"""  # noqa: E501
    ...
    def label_selector(self):
        """Gets the label_selector of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The label_selector of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
    ...
    def match_label_keys(self):
        """Gets the match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def match_label_keys(self, match_label_keys):
        ...
        :param match_label_keys: The match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def max_skew(self):
        """Gets the max_skew of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The max_skew of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: int
        """
    ...
    def max_skew(self, max_skew):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and max_skew is None:
    ...
    def min_domains(self):
        """Gets the min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: int
        """
    ...
    def min_domains(self, min_domains):
        ...
        :param min_domains: The min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :type: int
        """
    ...
    def node_affinity_policy(self):
        """Gets the node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501

        NodeAffinityPolicy indicates how we will treat Pod's nodeAffinity/nodeSelector when calculating pod topology spread skew. Options are: - Honor: only nodes matching nodeAffinity/nodeSelector are included in the calculations. - Ignore: nodeAffinity/nodeSelector are ignored. All nodes are included in the calculations.  If this value is nil, the behavior is equivalent to the Honor policy. This is a beta-level feature default enabled by the NodeInclusionPolicyInPodTopologySpread feature flag.  Possible enum values:  - `\"Honor\"` means use this scheduling directive when calculating pod topology spread skew.  - `\"Ignore\"` means ignore this scheduling directive when calculating pod topology spread skew.  # noqa: E501

        :return: The node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: str
        """
    ...
    def node_affinity_policy(self, node_affinity_policy):
        ...
        :param node_affinity_policy: The node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :type: str
        """
        allowed_values = ["Honor", "Ignore"]  # noqa: E501
        if (self._configuration.client_side_validation and
                node_affinity_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `node_affinity_policy` ({0}), must be one of {1}"  # noqa: E501
    ...
    def node_taints_policy(self):
        """Gets the node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501

        NodeTaintsPolicy indicates how we will treat node taints when calculating pod topology spread skew. Options are: - Honor: nodes without taints, along with tainted nodes for which the incoming pod has a toleration, are included. - Ignore: node taints are ignored. All nodes are included.  If this value is nil, the behavior is equivalent to the Ignore policy. This is a beta-level feature default enabled by the NodeInclusionPolicyInPodTopologySpread feature flag.  Possible enum values:  - `\"Honor\"` means use this scheduling directive when calculating pod topology spread skew.  - `\"Ignore\"` means ignore this scheduling directive when calculating pod topology spread skew.  # noqa: E501

        :return: The node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: str
        """
    ...
    def node_taints_policy(self, node_taints_policy):
        ...
        :param node_taints_policy: The node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :type: str
        """
        allowed_values = ["Honor", "Ignore"]  # noqa: E501
        if (self._configuration.client_side_validation and
                node_taints_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `node_taints_policy` ({0}), must be one of {1}"  # noqa: E501
    ...
    def topology_key(self):
        """Gets the topology_key of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The topology_key of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: str
        """
    ...
    def when_unsatisfiable(self):
        """Gets the when_unsatisfiable of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        ...
        :return: The when_unsatisfiable of this IoK8sApiCoreV1TopologySpreadConstraint.  # noqa: E501
        :rtype: str
        """
    ...
    def when_unsatisfiable(self, when_unsatisfiable):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and when_unsatisfiable is None:
        ...
        if (self._configuration.client_side_validation and
                when_unsatisfiable not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1TopologySpreadConstraint, dict):
