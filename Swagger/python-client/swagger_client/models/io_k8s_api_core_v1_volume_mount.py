...
class IoK8sApiCoreV1VolumeMount(object):
    ...
    def mount_propagation(self, mount_propagation):
        ...
        :type: str
        """
        allowed_values = ["Bidirectional", "HostToContainer", "None"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mount_propagation not in allowed_values):
            raise ValueError(
                "Invalid value for `mount_propagation` ({0}), must be one of {1}"  # noqa: E501
                .format(mount_propagation, allowed_values)
            )
