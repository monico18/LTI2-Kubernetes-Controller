...
class IoK8sApiFlowcontrolV1FlowSchemaSpec(object):
    ...
    """
    swagger_types = {
        'distinguisher_method': 'IoK8sApiFlowcontrolV1FlowDistinguisherMethod',
        'matching_precedence': 'int',
        'priority_level_configuration': 'IoK8sApiFlowcontrolV1PriorityLevelConfigurationReference',
        'rules': 'list[IoK8sApiFlowcontrolV1PolicyRulesWithSubjects]'
    }
    ...
    def __init__(self, distinguisher_method=None, matching_precedence=None, priority_level_configuration=None, rules=None, _configuration=None):  # noqa: E501
        """IoK8sApiFlowcontrolV1FlowSchemaSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def distinguisher_method(self):
        """Gets the distinguisher_method of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The distinguisher_method of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :rtype: IoK8sApiFlowcontrolV1FlowDistinguisherMethod
        """
        return self._distinguisher_method

    @distinguisher_method.setter
    def distinguisher_method(self, distinguisher_method):
        """Sets the distinguisher_method of this IoK8sApiFlowcontrolV1FlowSchemaSpec.

        `distinguisherMethod` defines how to compute the flow distinguisher for requests that match this schema. `nil` specifies that the distinguisher is disabled and thus will always be the empty string.  # noqa: E501

        :param distinguisher_method: The distinguisher_method of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
    ...
    def matching_precedence(self):
        """Gets the matching_precedence of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The matching_precedence of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def matching_precedence(self, matching_precedence):
        """Sets the matching_precedence of this IoK8sApiFlowcontrolV1FlowSchemaSpec.

        `matchingPrecedence` is used to choose among the FlowSchemas that match a given request. The chosen FlowSchema is among those with the numerically lowest (which we take to be logically highest) MatchingPrecedence.  Each MatchingPrecedence value must be ranged in [1,10000]. Note that if the precedence is not specified, it will be set to 1000 as default.  # noqa: E501

        :param matching_precedence: The matching_precedence of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :type: int
        """
    ...
    def priority_level_configuration(self):
        """Gets the priority_level_configuration of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The priority_level_configuration of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :rtype: IoK8sApiFlowcontrolV1PriorityLevelConfigurationReference
        """
    ...
    def priority_level_configuration(self, priority_level_configuration):
        """Sets the priority_level_configuration of this IoK8sApiFlowcontrolV1FlowSchemaSpec.

        `priorityLevelConfiguration` should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.  # noqa: E501

        :param priority_level_configuration: The priority_level_configuration of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
    ...
    @property
    def rules(self):
        """Gets the rules of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The rules of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :rtype: list[IoK8sApiFlowcontrolV1PolicyRulesWithSubjects]
        """
        return self._rules

    @rules.setter
    def rules(self, rules):
        """Sets the rules of this IoK8sApiFlowcontrolV1FlowSchemaSpec.

        `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.  # noqa: E501

        :param rules: The rules of this IoK8sApiFlowcontrolV1FlowSchemaSpec.  # noqa: E501
        :type: list[IoK8sApiFlowcontrolV1PolicyRulesWithSubjects]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiFlowcontrolV1FlowSchemaSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoK8sApiFlowcontrolV1FlowSchemaSpec):
            return False
