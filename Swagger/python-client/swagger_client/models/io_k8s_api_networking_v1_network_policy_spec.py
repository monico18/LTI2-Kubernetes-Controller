...
class IoK8sApiNetworkingV1NetworkPolicySpec(object):
    ...
    def __init__(self, egress=None, ingress=None, pod_selector=None, policy_types=None, _configuration=None):  # noqa: E501
    ...
    def pod_selector(self, pod_selector):
        ...
        """
        if self._configuration.client_side_validation and pod_selector is None:
