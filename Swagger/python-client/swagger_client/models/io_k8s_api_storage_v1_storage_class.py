...
class IoK8sApiStorageV1StorageClass(object):
    ...
    def __init__(self, allow_volume_expansion=None, allowed_topologies=None, api_version=None, kind=None, metadata=None, mount_options=None, parameters=None, provisioner=None, reclaim_policy=None, volume_binding_mode=None, _configuration=None):  # noqa: E501
    ...
    def provisioner(self, provisioner):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and provisioner is None:
    ...
    def reclaim_policy(self, reclaim_policy):
        ...
        if (self._configuration.client_side_validation and
                reclaim_policy not in allowed_values):
            raise ValueError(
                "Invalid value for `reclaim_policy` ({0}), must be one of {1}"  # noqa: E501
    ...
    def volume_binding_mode(self, volume_binding_mode):
        ...
        :type: str
        """
        allowed_values = ["Immediate", "WaitForFirstConsumer"]  # noqa: E501
        if (self._configuration.client_side_validation and
                volume_binding_mode not in allowed_values):
            raise ValueError(
                "Invalid value for `volume_binding_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(volume_binding_mode, allowed_values)
            )
