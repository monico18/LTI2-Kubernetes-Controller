...
class IoK8sApiStorageV1VolumeAttachmentSpec(object):
    ...
    def __init__(self, attacher=None, node_name=None, source=None, _configuration=None):  # noqa: E501
    ...
    def attacher(self, attacher):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and attacher is None:
