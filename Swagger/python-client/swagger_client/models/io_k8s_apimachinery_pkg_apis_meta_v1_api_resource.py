...
class IoK8sApimachineryPkgApisMetaV1APIResource(object):
    ...
    def __init__(self, categories=None, group=None, kind=None, name=None, namespaced=None, short_names=None, singular_name=None, storage_version_hash=None, verbs=None, version=None, _configuration=None):  # noqa: E501
    ...
    def namespaced(self, namespaced):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and namespaced is None:
    ...
    def singular_name(self, singular_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and singular_name is None:
