...
class IoK8sApimachineryPkgApisMetaV1APIVersions(object):
    ...
    def __init__(self, api_version=None, kind=None, server_address_by_client_cidrs=None, versions=None, _configuration=None):  # noqa: E501
    ...
    def server_address_by_client_cidrs(self):
        """Gets the server_address_by_client_cidrs of this IoK8sApimachineryPkgApisMetaV1APIVersions.  # noqa: E501
        ...
        :return: The server_address_by_client_cidrs of this IoK8sApimachineryPkgApisMetaV1APIVersions.  # noqa: E501
    ...
    def server_address_by_client_cidrs(self, server_address_by_client_cidrs):
        """Sets the server_address_by_client_cidrs of this IoK8sApimachineryPkgApisMetaV1APIVersions.

        a map of client CIDR to server address that is serving this group. This is to help clients reach servers in the most network-efficient way possible. Clients can use the appropriate server address as per the CIDR that they match. In case of multiple matches, clients should use the longest matching CIDR. The server returns only those CIDRs that it thinks that the client can match. For example: the master will return an internal IP CIDR only, if the client reaches the server using an internal IP. Server looks at X-Forwarded-For header or X-Real-Ip header or request.RemoteAddr (in that order) to get the client IP.  # noqa: E501

        :param server_address_by_client_cidrs: The server_address_by_client_cidrs of this IoK8sApimachineryPkgApisMetaV1APIVersions.  # noqa: E501
        :type: list[IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR]
        """
        if self._configuration.client_side_validation and server_address_by_client_cidrs is None:
