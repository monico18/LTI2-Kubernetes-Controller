...
class IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR(object):
    ...
    def __init__(self, client_cidr=None, server_address=None, _configuration=None):  # noqa: E501
    ...
    def client_cidr(self, client_cidr):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and client_cidr is None:
    ...
    def server_address(self, server_address):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and server_address is None:
