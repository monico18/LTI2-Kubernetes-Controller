...
class IoK8sApimachineryPkgVersionInfo(object):
    ...
    def __init__(self, build_date=None, compiler=None, git_commit=None, git_tree_state=None, git_version=None, go_version=None, major=None, minor=None, platform=None, _configuration=None):  # noqa: E501
    ...
    def git_version(self, git_version):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and git_version is None:
